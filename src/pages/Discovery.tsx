...
const Discovery = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col pt-16 px-4 relative overflow-hidden">
      {/* Background shapes */}
      <motion.div
        className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-[#9b87f5]/10 to-transparent rounded-full blur-3xl"
        animate={{
          x: [0, 50, 0],
          y: [0, 30, 0],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-[#1EAEDB]/10 to-transparent rounded-full blur-3xl"
        animate={{
          x: [0, -30, 0],
          y: [0, 50, 0],
        }}
