...
const Navbar = () => {
  ...
  const [authDialog, setAuthDialog] = useState<{ isOpen: boolean; view: "login" | "register" }>({
    isOpen: false,
    view: "login"
  });
      ...
      >
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              onClick={() => setAuthDialog({ isOpen: true, view: "login" })}
              className="text-white/80 hover:text-white transition-colors"
            >
              Login
            </button>
            <button
              onClick={() => setAuthDialog({ isOpen: true, view: "register" })}
