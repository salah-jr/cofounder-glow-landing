...
export default function PhaseTask({ 
  ...
  return (
    <motion.div
      className={cn(
        "w-full px-4 lg:px-4 py-2 lg:py-3 transition-all border-b border-white/10", // Added left padding for indentation
        ...
        isClickable && "cursor-pointer hover:bg-gradient-to-r hover:from-[#9b87f5]/5 hover:to-[#1EAEDB]/5"
      )}
      onClick={handleClick}
