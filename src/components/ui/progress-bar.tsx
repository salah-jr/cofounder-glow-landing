        ...
        <div className="absolute top-0 left-0 w-full flex justify-between my-[4px]">
          ...
          return <div key={index} className="flex flex-col items-center relative" style={{
            transform: 'translateY(-50%)'
                ...
                <motion.div className={cn("rounded-full flex items-center justify-center border transform transition-all duration-300", 
                ...
                animate={isCurrent ? {
                  ...
                  {isCompleted && <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white">
